 ...
 * built-in presets the web LLM Configuration modal offers. Each entry selects
 * the matching native or OpenAI-compatible adapter by id. */
...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { id: 'anthropic',  label: 'Anthropic',  baseUrl: 'https://api.anthropic.com/v1',  defaultModel: 'claude-sonnet-4-6',            needsKey: true },
