...
| `@esbuild/android-x64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/darwin-arm64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/darwin-x64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/freebsd-arm64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/freebsd-x64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-arm` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-arm64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-ia32` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-loong64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-mips64el` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-ppc64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-riscv64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-s390x` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/linux-x64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/netbsd-arm64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/netbsd-x64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/openbsd-arm64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/openbsd-x64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/openharmony-arm64` | 0.28.1 | MIT | CLI package |  |
| `@esbuild/sunos-x64` | 0.28.1 | MIT | CLI package |  |
...
| `@types/debug` | 4.1.13 | MIT | Web package |  |
| `@types/deep-eql` | 4.0.2 | MIT | CLI package |  |
| `@types/estree` | 1.0.9 | MIT | CLI package, Web package |  |
...
| `escalade` | 3.2.0 | MIT | CLI package, Web package |  |
| `escape-html` | 1.0.3 | MIT | CLI package |  |
| `escape-string-regexp` | 5.0.0 | MIT | Web package |  |
...
| `lightningcss-darwin-x64` | 1.32.0 | MPL-2.0 | CLI package, Web package |  |
| `lightningcss-freebsd-x64` | 1.32.0 | MPL-2.0 | CLI package, Web package |  |
| `lightningcss-linux-arm-gnueabihf` | 1.32.0 | MPL-2.0 | CLI package, Web package |  |
| `lightningcss-linux-arm64-gnu` | 1.32.0 | MPL-2.0 | CLI package, Web package |  |
| `lightningcss-linux-arm64-musl` | 1.32.0 | MPL-2.0 | CLI package, Web package |  |
| `lightningcss-linux-x64-gnu` | 1.32.0 | MPL-2.0 | CLI package, Web package |  |
...
| `mdast-util-from-markdown` | 2.0.3 | MIT | Web package |  |
| `mdast-util-gfm` | 3.1.0 | MIT | Web package |  |
| `mdast-util-gfm-autolink-literal` | 2.0.1 | MIT | Web package |  |
| `mdast-util-gfm-footnote` | 2.1.0 | MIT | Web package |  |
| `mdast-util-gfm-strikethrough` | 2.0.0 | MIT | Web package |  |
| `mdast-util-gfm-table` | 2.0.0 | MIT | Web package |  |
| `mdast-util-gfm-task-list-item` | 2.0.0 | MIT | Web package |  |
| `mdast-util-mdx-expression` | 2.0.1 | MIT | Web package |  |
...
| `micromark-extension-gfm-autolink-literal` | 2.1.0 | MIT | Web package |  |
| `micromark-extension-gfm-footnote` | 2.1.0 | MIT | Web package |  |
| `micromark-extension-gfm-strikethrough` | 2.1.0 | MIT | Web package |  |
| `micromark-extension-gfm-table` | 2.1.1 | MIT | Web package |  |
| `micromark-extension-gfm-tagfilter` | 2.0.0 | MIT | Web package |  |
| `micromark-extension-gfm-task-list-item` | 2.1.0 | MIT | Web package |  |
| `micromark-factory-destination` | 2.0.1 | MIT | Web package |  |
| `micromark-factory-label` | 2.0.1 | MIT | Web package |  |
